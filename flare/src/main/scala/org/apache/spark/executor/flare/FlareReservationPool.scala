...
sealed trait FlareReservationPool {
  def maxShare: Int
  def weight: Double
...
class FlareReservationPoolGroup(name: String, val maxShare: Int, val weight: Double) extends FlareReservationPool with Logging{
...
class FlareReservationPoolNode(reservationId: FlareReservationId, var count: Int, parent: FlareReservationPoolGroup) extends FlareReservationPool{
  var _runningTasks = 0
